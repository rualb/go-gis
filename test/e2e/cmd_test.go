...
func TestCmd(t *testing.T) {
	...
	urls := []struct {
		...
		{title: "test loc to address", search: []string{`"address"`, "London"}, url: "http://127.0.0.1:31180/gis/api/geocode", query: map[string]string{"lang": "en", "lat_lng": "51.50814,-0.12848"}},
	}
